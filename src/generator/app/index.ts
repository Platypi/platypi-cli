...
export default class AppGenerator extends Generator {
    ...
    promptCordova(cordova: boolean): Promise<boolean> {
        if (!cordova) {
            ...
            .prompt([
                {
                    ...
                    default: true,
                    type: 'confirm',
                    message: `Should we create a Cordova project?`,
                },
            ])
    ...
    promptGitIgnore(gitignore: boolean): Promise<boolean> {
        if (!gitignore) {
            ...
            .prompt([
                {
                    ...
                    default: true,
                    type: 'confirm',
                    message: `Should we create a .gitignore?`,
                },
            ])
    ...
    promptName(name: string = ''): Promise<string> {
        ...
        if (!this.utils.isEmpty(name)) {
            ...
            if (
                this.utils.isArray(valid.errors) ||
                this.utils.isArray(valid.warnings)
            ) {
                this.ui.warn('');
    ...
    promptDir(dir: string = '', defaults?: string): Promise<string> {
        dir = dir.trim();
            ...
            .prompt([
                {
                    ...
                    default: defaults,
                    type: 'input',
                    message: `Where should this app be created?`,
                },
            ])
